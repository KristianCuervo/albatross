...
from microscale import Ensemble, Solver, sweep_min_vref, sweep_max_vmg
from mesoscale.velocity_hull import VelocityHull
...
if RECOMPUTE:
    ...
    hull = VelocityHull.from_ensemble(ens_vmg)
    hull.save(HULL_NPZ)
